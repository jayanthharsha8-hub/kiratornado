        ...
        {TABS.map(({ to, label, icon: Icon }) => {
          ...
          return (
            <NavLink
              ...
              className={cn(
                "relative flex flex-1 flex-col items-center justify-center gap-0.5 rounded-sm px-1 py-1.5 transition-all duration-200",
            ...
            >
              ...
              <Icon
                className={cn("h-4 w-4 transition-transform", active && "scale-105 text-glow-soft")}
              />
