  ...
  return (
    <div className="relative min-h-screen pb-20 scanline">
      ...
      <main className="mx-auto max-w-md space-y-3 px-3 pt-3">
        <SystemPanel title="Custom Rooms">
          <div className="flex flex-col items-center justify-center gap-3 py-10 text-center">
            <DoorOpen className="h-12 w-12" style={{ color: ACCENT, filter: `drop-shadow(0 0 8px ${ACCENT})` }} />
            ...
            <p className="max-w-[18rem] text-xs text-muted-foreground">
              Create or join private rooms with your squad. Custom matches launching soon.
            </p>
